    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="mb-4 sm:mb-6">
          <div className="flex items-center space-x-2 text-xs sm:text-sm text-gray-600" style={{fontSize: '16px'}}>
        ...
        <div className="relative mb-6 sm:mb-8">
          <div className="absolute left-0 top-0 w-12 h-12 sm:w-16 sm:h-16 opacity-20">
            <div className="w-full h-full bg-gradient-to-br from-green-200 to-green-300 rounded-full"></div>
          </div>
          <div className="absolute right-0 top-0 w-8 h-8 sm:w-12 sm:h-12 opacity-20">
            <div className="w-full h-full bg-gradient-to-br from-pink-200 to-pink-300 rounded-full"></div>
          </div>
          
          <div className="relative z-10">
            <h1 className="font-bold text-gray-900 mb-3 sm:mb-4" style={{fontSize: 'clamp(20px, 5vw, 25px)'}}>
              {vendor.name}
            </h1>
          </div>
        </div>
        ...
        <div className="mb-6 sm:mb-8">
          <div className="relative h-48 sm:h-64 md:h-80 lg:h-96 rounded-lg sm:rounded-xl overflow-hidden">
            <Image
            ...
            {vendor.images.length > 1 && (
              <>
                <button
                  onClick={prevImage}
                  className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full flex items-center justify-center transition-all"
                >
                ...
                <button
                  onClick={nextImage}
                  className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-white bg-opacity-80 hover:bg-opacity-100 rounded-full flex items-center justify-center transition-all"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 order-2 lg:order-1">
            <Card className="lg:sticky lg:top-8">
              <CardHeader>
                <CardTitle style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>Details</CardTitle>
              </CardHeader>
          ...
          <div className="lg:col-span-2 space-y-8 order-1 lg:order-2">
            {/* About Section */}
            <div>
              <h2 className="font-bold text-gray-900 mb-3 sm:mb-4" style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>About This {vendor.category}</h2>
              <div className="space-y-3 sm:space-y-4 text-gray-700" style={{fontSize: '16px'}}>
              ...
              {(vendor.ownerMobile1 || vendor.managerMobile1 || vendor.ownerEmail || vendor.businessEmail) && (
                <Card className="mt-4 sm:mt-6">
                  <CardHeader>
                    <CardTitle style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>Contact Information</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3 sm:space-y-4" style={{fontSize: '16px'}}>
                    {vendor.ownerName && (
                      <div>
              ...
              {(vendor.area || vendor.completeAddress) && (
                <Card className="mt-4 sm:mt-6">
                  <CardHeader>
                    <CardTitle style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>Location Details</CardTitle>
                  </CardHeader>
              ...
              <div className="mt-4 sm:mt-6">
                <p className="font-bold text-red-600 mb-3 sm:mb-4" style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <Button 
                    variant="outline" 
                    className="flex items-center justify-center space-x-2 bg-green-50 hover:bg-green-100 border-green-200 w-full sm:w-auto" 
                    style={{fontSize: '16px'}}
                    onClick={() => {
                  ...
                  {(vendor.ownerMobile1 || vendor.managerMobile1) && (
                    <Button 
                      className="bg-red-600 hover:bg-red-700 text-white flex items-center justify-center space-x-2 w-full sm:w-auto" 
                      style={{fontSize: '16px'}}
                      onClick={() => {
                    ...
                    >
                      ...
                      <span className="hidden sm:inline">Call Now {vendor.ownerMobile1 || vendor.managerMobile1}</span>
            ...
            <Card>
              <CardHeader>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
                  <div>
                    <CardTitle style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>Reviews</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{fontSize: 'clamp(18px, 4vw, 22px)'}}>Similar Venues You May Like</CardTitle>
              </CardHeader>
              <CardContent>
