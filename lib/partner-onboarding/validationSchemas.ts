...
export const baseFormSchema = z.object({
  ...
  otherVenueType: z.string().optional(),
  singleOrMultiple: z.string().optional(),
  ...
  venueWheelchairAccessible: z.string().optional(),
  wheelchairAvailable: z.string().optional(),
  namazAreaMen: z.string().optional(),
  namazAreaLadies: z.string().optional(),
  amenities: z.string().optional(),
  decorationAmbience: z.boolean().optional(),
  soundSystem: z.boolean().optional(),
  hallDecor: z.boolean().optional(),
  stageDecor: z.boolean().optional(),
  ...
  venueGenerator: z.boolean().optional(),
  dedicatedStaff: z.boolean().optional(),
  executiveLounge: z.boolean().optional(),
  otherServicesOffered: z.string().optional(),
  cateringServices: z.string().optional(),
  decorServices: z.string().optional(),
  venueAdditionalInfo: z.string().optional(),
