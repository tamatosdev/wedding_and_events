...
export default function DecorPolicies() {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-[#666666]">Define your décor policies and terms</p>
      </div>
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <Textarea
              ...
              placeholder="Describe your cancellation policy, refund terms, setup charges, etc."
              rows={4}
