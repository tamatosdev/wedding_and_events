    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Card className="border-rose-200 bg-white/50">
        ...
        <CardContent className="space-y-6">
          <div>
            <Label htmlFor="businessName2" className="text-gray-700">
              Business Name <span className="text-rose-500">*</span>
            </Label>
            <Input
              id="businessName2"
              {...register('businessName2')}
              placeholder="Enter business name"
              className="mt-2 border-gray-300 focus:border-rose-400 focus:ring-rose-400"
            />
            {errors.businessName2 && (
              <p className="text-rose-500 text-sm mt-1">{errors.businessName2.message}</p>
            )}
          </div>
